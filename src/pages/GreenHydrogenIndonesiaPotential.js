...
export default function GreenHydrogenIndonesiaPotential() {
    return (
        <>
            {/*  Fluid Section One */}
                ...
                <div className="outer-box clearfix">
                    ...
                    <div className="content-column">
                        <div className="inner-column">
                            <div>
                                <p className='fw-bold primary-color text-size-10 text-size-lg-15'>INDONESIA <span className='text-size-5 text-size-lg-8'>GREEN HYDROGEN</span></p>
                                <p className='fw-bold text-size-20 text-size-lg-25'>POTENTIAL</p>
            ...
            <section className='d-flex flex-wrap justify-content-center vh-100 p-3 p-lg-5' style={{ background: `url(${BackgroundBanner2}) no-repeat`, backgroundSize: 'cover', backgroundPosition: 'center' }}>            </section>
